...
# is taking the raw tmin coefficient (later SE) values from all the 4823 files and compiling
...
#SBATCH --job-name=xjan
#SBATCH --error=/scratch/users/tballard/tmin.extracts/cleaned/compile.errors.se.jan.err
#SBATCH --output=/scratch/users/tballard/tmin.extracts/cleaned/compile.terminal.output.se.jan.out
#SBATCH --qos=normal
#SBATCH --nodes=1
...
parallel -j0 Rscript :::: <(ls compile.se.*.values.R)
